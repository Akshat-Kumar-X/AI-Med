        ...
        <>  
            <div className='relative flex flex-col w-full justify-center items-center bg-cover bg-center bg-gradient-to-tr  from-sky-300 via-sky-400 to-blue-500 bg-white rounded-lg p-10 mx-3 my-4 shadow-md' style={{ backgroundImage:"url('/assets/images/swirl.jpg')" }}>
                ...
                <div className='flex flex-col gap-3 md:flex-row md:w-3/4 justify-center items-center md:gap-0'>
                    ...
                    <form class="flex items-center max-w-sm w-full md:me-2 z-10">   
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text"  value={nameQuery} onChange={handleNameChange} placeholder="Search by Doctor Name..." id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500  focus:border-blue-500 block w-full ps-10 p-2.5" required />
                        </div>
                    </form>
 
                    <form class="flex items-center max-w-sm w-full z-10">   
                        <label for="simple-search" class="sr-only">Search</label>
                        <div class="relative w-full">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                            ...
                            <input type="text" value={specialtyQuery} onChange={handleSpecialtyChange} placeholder="Search by Speciality..." id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" required />
                        </div>
                    </form>

                    <form class="flex items-center max-w-sm w-full md:ms-2 z-10">   
                        <label for="simple-search" class="sr-only">Search</label>
                        <div class="relative w-full">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                            ...
                            <input type="text" value={locationQuery} onChange={handleLocationChange} placeholder="Search by Location..." id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" required />
                        </div>
                        <button type="submit" class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-600 rounded-lg border border-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300">
                ...
                <div class="absolute inset-0 bg-gradient-to-tr  from-sky-300 via-sky-400 to-blue-500 bg-white  opacity-50 rounded-lg "></div>
            </div>
